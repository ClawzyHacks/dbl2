...
client.ayarlar = {
  "prefix": "+", //prefix
  "oauthSecret": "GF8aERw_0oBJ4GpXhxu4Fs9Pooe-gkkg", //bot secreti
	"callbackURL": "https://koala-bot-list.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "592841139015385128", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
  "renk": "RANDOM" //embedların rengini burdan alıo can sıkıntısdna yapılmış bişe falan fln
};

client.yetkililer = ["533690155551162415"] //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = ["533690155551162415"] //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = ["533690155551162415"] //sunucu yetkililerin ıdleri gelcek array
...
client.on("message", async message => {
    ...
    if (cmd.conf.permLevel === 'ozel') { //o komutu web yetkilileri kullanabsiln sadece diye yaptıgım bişe 
      ...
      var arr = [x.owner.id, '581609545403727888']
...
client.login("NTkyODI1ODIxMjc0ODMyODk2.XRFLJQ.IRpA0c5Mor7a-5USZnkZu81aq9c") //tokeni yaz işte
